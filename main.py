...
window = tk.Tk()
window.title("Smart cctv survillience")
...
icon = icon.resize((150,150), PIL.Image.Resampling.LANCZOS)

icon = ImageTk.PhotoImage(icon)
label_icon = tk.Label(frame1, image=icon)
label_icon.grid(row=1, pady=(5,10), column=2)
btn1_image = Image.open('icons/lamp.png')
btn1_image = btn1_image.resize((50,50),PIL.Image.Resampling.LANCZOS) 
btn1_image =ImageTk.PhotoImage(btn1_image)
btn2_image = Image.open('icons/rectangle.jpg')

btn2_image = btn2_image.resize((50,50),PIL.Image.Resampling.LANCZOS) 
btn2_image =ImageTk.PhotoImage(btn2_image)
btn5_image = Image.open('icons/exit.png')
btn5_image = btn5_image.resize((50,50),PIL.Image.Resampling.LANCZOS)
btn5_image =ImageTk.PhotoImage(btn5_image)
btn3_image = Image.open('icons/security.jpg')
btn3_image = btn3_image.resize((50,50),PIL.Image.Resampling.LANCZOS) 
btn3_image =ImageTk.PhotoImage(btn3_image)



btn6_image = Image.open('icons/incognito.png')
btn6_image = btn6_image.resize((50,50), PIL.Image.Resampling.LANCZOS)
btn6_image = ImageTk.PhotoImage(btn6_image)
btn4_image = Image.open('icons/recording.jpg')
btn4_image = btn4_image.resize((50,50), PIL.Image.Resampling.LANCZOS)
btn4_image = ImageTk.PhotoImage(btn4_image)
btn7_image = Image.open('icons/recording.jpg')
btn7_image = btn7_image.resize((50,50), PIL.Image.Resampling.LANCZOS)
